...
var IndecisionApp = function (_React$Component) {
  ...
  _createClass(IndecisionApp, [{
    ...
    value: function handlePick() {
      var pickKey = Math.floor(Math.random() * this.state.options.length);
      var option = this.state.options[pickKey];
      alert(option);
    }
  }, {
    key: 'handleAddOption',
    ...
    value: function render() {
      ...
      var subTitle = "Find your best decision!";
      return _react2.default.createElement(
        'div',
        null,
